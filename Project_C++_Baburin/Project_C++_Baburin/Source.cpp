...
int CALLBACK wWinMain(HINSTANCE hInstance, HINSTANCE, PWSTR szCmdLine, int nCmdShow)
{
	...
	if (!RegisterClassEx(&wc))
		return EXIT_FAILURE;
	if (hwnd = CreateWindowEx(0, wc.lpszClassName, L"Paint on C++: beta version", WS_OVERLAPPEDWINDOW, 150, 150, 1500, 700, nullptr, nullptr, wc.hInstance, nullptr); hwnd == INVALID_HANDLE_VALUE)
		return EXIT_FAILURE;
